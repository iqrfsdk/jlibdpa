...
public final class FRC_TimingParams extends TimingParams {
    ...
    private final FRC_ResponseTime responseTime;
    ...
    public static final FRC_ResponseTime DEFAULT_RESPONSE_TIME = FRC_ResponseTime.TIME_40_MS;
    ...
    public FRC_TimingParams() {
        ...
        this.responseTime = DEFAULT_RESPONSE_TIME;
    }
     ...
     */
    public FRC_TimingParams(
        int bondedNodesNum, RF_Mode rfMode, FRC_ResponseTime responseTime
    ) {
     ...
     */
    public FRC_ResponseTime getResponseTime() {
    ...
    public String toString() {
        ...
        strBuilder.append(" Response time: " + this.responseTime + NEW_LINE);
        strBuilder.append("}");
